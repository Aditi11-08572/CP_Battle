...
const Mainboard = () => {
  ...
  const fetchNotifications = async () => {
    try {
      ...
      const response = await axios.get(`https://cp-battle.onrender.com/api/notifications/${userEmail}`);
  ...
  const markAllAsRead = async () => {
    try {
      const userEmail = localStorage.getItem('userEmail');
      await axios.post(`https://cp-battle.onrender.com/api/notifications/${userEmail}/mark-read`);
      setUnreadCount(0);
  ...
  const deleteNotification = async (notificationId) => {
    try {
      ...
      await axios.delete(`https://cp-battle.onrender.com/api/notifications/${notificationId}`);
...
const copyToClipboard = async (code) => {
  ...
  const handleJoinContest = async () => {
    try {
      ...
      const response = await axios.get(`https://cp-battle.onrender.com/api/contests/${contestCode}/check-invitation`, {
        params: { userEmail }
      });
  ...
  const fetchRegisteredContests = async () => {
    try {
      ...
      const response = await axios.get(`https://cp-battle.onrender.com/api/user-contests`, {
        params: { userEmail }
      });
  ...
  const fetchOngoingContests = async () => {
    try {
      ...
      const response = await axios.get(`https://cp-battle.onrender.com/api/ongoing-contests`, {
        params: { userEmail }
      });
  ...
  const fetchPastContests = async () => {
    try {
      ...
      setError(null);
      const userEmail = localStorage.getItem('userEmail');
      const response = await axios.get(`https://cp-battle.onrender.com/api/past-contests`, {
        params: { userEmail }
      });
