...
const LoginSignup = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            const response = await fetch('https://codecraft-contest1.onrender.com/api/auth/signin', {
                method: 'POST',
    ...
    const handleSignup = async (e) => {
        e.preventDefault();
        try {
            const checkResponse = await axios.post('https://codecraft-contest1.onrender.com/api/auth/check-user', { email });
