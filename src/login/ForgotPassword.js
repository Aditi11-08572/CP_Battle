...
const ForgotPassword = () => {
    ...
    const handleVerifyOtp = async (e) => {
        e.preventDefault();
        try {
            const response = await fetch('https://cp-battle.onrender.com/api/auth/verify-otp', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    const handleResetPassword = async (e) => {
        e.preventDefault();
        try {
            const response = await fetch('https://cp-battle.onrender.com/api/auth/reset-password', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
