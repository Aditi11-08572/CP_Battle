...
const ContestProblemsTable = () => {
  ...
  useEffect(() => {
    const fetchUserHandle = async () => {
      ...
      try {
        ...
        const response = await axios.get(`https://cp-battle.onrender.com/api/user`, {
  ...
  const calculateRating = async () => {
    try {
      ...
      const userResponse = await axios.get(`https://cp-battle.onrender.com/api/user`, {
        params: { email: userEmail }
      });
  ...
  const handleSubmitContest = async () => {
    ...
    try {
      ...
      const response = await axios.post('https://cp-battle.onrender.com/api/contests/submit', contestData);
